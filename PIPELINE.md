...
- **Domains**: `app` · `session` · `conversation` · `diff` · `shell` · `agents` · `workflows` · `mcp` · `skills` · `palette` · `cli` · `project` · `standards` · `profiles` · `permissions` · `remote` · `account` · `cloud` · `extensions` · `github`
